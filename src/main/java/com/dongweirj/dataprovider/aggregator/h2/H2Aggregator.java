...
public class H2Aggregator extends InnerAggregator {
    ...
    public String[] queryDimVals(String columnName, AggConfig config) throws Exception {
        ...
        exec = String.format(fsql, SqlHelper.surround(columnName, "`"), getTmpTblName(), whereStr, SqlHelper
                .surround(columnName, "`"));
        LOG.info(exec);
        try (Connection conn = jdbcDataSource.getConnection();
    ...
    public AggregateResult queryAggData(AggConfig config) throws Exception {
        ...
        try (
            ...
            stat.execute("CREATE ALIAS IF NOT EXISTS f_todouble FOR \"com.dongweirj.dataprovider.aggregator.h2.Functions.parserString2Double\" ");
